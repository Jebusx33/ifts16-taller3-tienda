...
export class ProductoService {
  ...
  // registrar producto registro_producto_admin
  registro_producto_admin(data: any, file: any, token: any): Observable<any> {
    ...
    fd.append('descripcion',data.contenido);
    ...
    agregar_imagen_galeria_admin(data: any, id:any, token: any):Observable<any>{
      let headers = new HttpHeaders({'Authorization':token});
      const fd = new FormData();
    ...
    eliminar_imagen_galeria_admin(data: any, id:any, token: any):Observable<any>{
      let headers = new HttpHeaders({'Content-Type':'application/json','Authorization':token});
