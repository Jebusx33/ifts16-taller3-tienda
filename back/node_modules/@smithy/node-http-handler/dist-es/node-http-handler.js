...
<<<<<<< HEAD:back/node_modules/@smithy/node-http-handler/dist-es/node-http-handler.js
            writeRequestBodyPromise = writeRequestBody(req, request, this.config.requestTimeout).catch(_reject);
=======
            writeRequestBodyPromise = writeRequestBody(req, request, this.config.requestTimeout);
>>>>>>> origin/desarrollo:back/node_modules/@aws-sdk/node-http-handler/dist-es/node-http-handler.js
        });
    }
}
